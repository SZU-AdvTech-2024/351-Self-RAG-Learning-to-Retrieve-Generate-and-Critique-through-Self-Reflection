...
class Retriever:
    ...
    def setup_retriever(self):
        print(f"Loading model from: {self.args.retrieve_model_path}")
        self.model, self.tokenizer, _ = src.contriever.load_retriever(self.args.retrieve_model_path)
        self.model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--retrieve_model_path", type=str, help="path to retrieve model"
    )
