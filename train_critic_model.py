...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer, skip_tokens=None,
        ...
        prompt_input, prompt_no_input, prompt_no_input_paragraph, prompt_no_input_separated = PROMPT_DICT[
            "prompt_input"], PROMPT_DICT["prompt_no_input"], PROMPT_DICT["prompt_no_input_paragraph"], PROMPT_DICT[
...
def make_supervised_data_module(tokenizer: transformers.PreTrainedTokenizer, data_args, skip_tokens=None,
                                context_markups=None) -> Dict:
    """Make dataset and collator for supervised fine-tuning."""
    train_dataset = SupervisedDataset(tokenizer=tokenizer, data_path=data_args.data_path, skip_tokens=skip_tokens,
                                      context_markups=context_markups, separated=data_args.separated)
...
def train():
    ...
    if model_args.use_special_token is True:
        special_token_dict = {
            "additional_special_tokens": ["[No Retrieval]", "[Retrieval]", "[Continue to Use Evidence]", "[Irrelevant]",
                                          "[Relevant]", "<paragraph>", "</paragraph>", "[Utility:1]", "[Utility:2]",
                                          "[Utility:3]", "[Utility:4]", "[Utility:5]", "[Fully supported]",
